    ...
    <div id="container">
        ...
        <div id="container__primeraInfo">
            <div class="container_primeraInf-aside">
                ...
                <div class="condicio-estado"><i class="fas fa-map-marked-alt"></i><?=($consulta['estado']);?></div>
    ...
    <div id="container2">
        <div id="aside1">
            ...
            <div id="caracteristicas">
                ...
                <table id="tablacarac">
                    <?php
                        $caracQuery = mysqli_query($conexion, "SELECT * FROM caracteristica WHERE idpublicacion = ".$consulta['id']);
                        if(!$caracQuery){
                            echo("Error al consultar caracterst");
                        }

                        while($row = mysqli_fetch_array($caracQuery)){
                    ?>
                    <tr>
                        <td><?= $row['concepto'] ?></td>
